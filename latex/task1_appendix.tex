...
\begin{document}
	...
	% subsection Task 1a (end)
	
	\subsection*{Task 1b} % (fold)
	\label{ssec:Task 1b}
	...
	% subsection Task 1b (end)

	\subsection*{Task 1c} % (fold)
	\label{ssec:Task 1b}
	...
	% subsection Task 1c (end)

	\subsection*{Task 1c boundary condition proof} % (fold)
	\label{ssec:Task 1c}
